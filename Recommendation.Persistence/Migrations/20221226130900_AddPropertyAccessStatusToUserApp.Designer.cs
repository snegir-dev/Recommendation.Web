...
namespace Recommendation.Persistence.Migrations
{
    ...
    [Migration("20221226130900_AddPropertyAccessStatusToUserApp")]
    partial class AddPropertyAccessStatusToUserApp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Recommendation.Domain.ImageInfo", b =>
                {
                    b.HasOne("Recommendation.Domain.Review", "Review")
                        .WithOne("ImageInfo")
                        .HasForeignKey("Recommendation.Domain.ImageInfo", "ReviewId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
